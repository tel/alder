...
object Selector {
  ...
  object Element {
    ...
    object Svg {
      val text: Selector[Any] = Element("text")
      val circle: Selector[Any] = Element("circle")
      val stop: Selector[Any] = Element("stop")
      val defs: Selector[Any] = Element("defs")
      val svg: Selector[Any] = Element("svg")
      val radialGradient: Selector[Any] = Element("radialGradient")
      val clipPath: Selector[Any] = Element("clipPath")
      val pattern: Selector[Any] = Element("pattern")
      val g: Selector[Any] = Element("g")
      val line: Selector[Any] = Element("line")
      val linearGradient: Selector[Any] = Element("linearGradient")
      val polyline: Selector[Any] = Element("polyline")
      val rect: Selector[Any] = Element("rect")
      val mask: Selector[Any] = Element("mask")
      val polygon: Selector[Any] = Element("polygon")
      val image: Selector[Any] = Element("image")
      val path: Selector[Any] = Element("path")
      val tspan: Selector[Any] = Element("tspan")
      val ellipse: Selector[Any] = Element("ellipse")
    }
  }
