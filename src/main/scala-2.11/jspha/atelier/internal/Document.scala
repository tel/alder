...
abstract class Document {
  ...
  def +/+(hd: String): Document = DocText(hd) ++ DocBreak ++ this
  ...
  def mkString: String = mkString(80)
...
object Document {
  ...
  private case object DocBreak extends Document
  ...
  def lines(docs: Seq[Document]): Document =
